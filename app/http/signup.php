...
if(isset($_POST['username']) &&
   ...
   if (empty($name)) {
      ...
      # error message
   	  $em = "Digite o seu nome de usuario porfavor!";
      ...
      */
   	  ...
   	  # error message
   	  $em = "Palavra-passe é requisitada";
      ...
      */
      ...
      if($stmt->rowCount() > 0){
				...
				**/
				if (in_array($img_ex_lc, $allowed_exs)) {
					...
					**/
					...
					$em = "Você precisa verficar o tipo de arquivo";
			      	header("Location: ../../signup.php?error=$em&$data");
			   	    exit;
				}
      	...
      	# success message
      	$sm = "A sua conta no chat Águia Branca foi criada agora";

      	# redirect to 'index.php' and passing success message
      	header("Location: ../../princi.php?success=$sm");
     	exit;
      }
